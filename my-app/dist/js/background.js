...
eval("/* provided dependency */ var browser = __webpack_require__(/*! webextension-polyfill */ \"./node_modules/webextension-polyfill/dist/browser-polyfill.js\");\nbrowser.runtime.onMessage.addListener(function (request, sender, sendResponse) {\n  console.log('Hello from the background' + request + sender + sendResponse);\n  browser.tabs.executeScript({\n    file: 'content-script.js'\n  });\n});\n\n//# sourceURL=webpack://tracker-hunt/./src/background.js?");
